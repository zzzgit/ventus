...
class MemberMngment extends Component {
	constructor(props) {
		...
		this.state = {
			...
			tableData_ds: [
				{ oid: 33, owner: "老王", type: 1, audit: 1, balance: 4544, member: 4543, website: "一個網站", app: "ok", status: 2, operation:"somethisng", admin: "張經理"},
			...
			columns: [
				...
				},
				{
					...
					render(row){
						return (
							<section>
								<article><span>業主：{row.owner}</span></article>
								<article><span>管理員：{row.admin}</span></article>
							</section>
						)
					}
				},
...
export default withRouter(MemberMngment)
